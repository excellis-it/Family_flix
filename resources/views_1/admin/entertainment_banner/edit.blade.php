        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <form action="{{ route('update.entertainment-banner') }}" method="POST" id="project-create-form"
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    <select name="banner_type" class="form-control">
                                        <option value="Shows"
                                            {{ $banner_detail->banner_type == 'Shows' ? 'selected' : '' }}>Shows</option>
                                        <option value="Movies"
                                            {{ $banner_detail->banner_type == 'Movies' ? 'selected' : '' }}>Movies</option>
                                        <option value="Kids"
                                            {{ $banner_detail->banner_type == 'Kids' ? 'selected' : '' }}>Kids</option>
                                    </select>
                                ...
                                @if ($banner_detail->banner_image != '')
                                    <img src="{{ Storage::url($banner_detail->banner_image) }}" alt="preview image"
                                        style="height: 150px;width: 500px;">
                                @else
                                    <img id="preview-back-image" src="{{ asset('admin_assets/images/NoImageFound.jpg') }}"
                                ...
                                @if ($banner_detail->banner_logo != '')
                                    <img src="{{ Storage::url($banner_detail->banner_logo) }}" alt="preview image"
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <textarea name="long_description" class="form-control" rows="4" cols="6">{{ $banner_detail->long_description }}</textarea>
