        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="w-100 text-end mb-3">
                    <a class="print_btn" href="{{ route('managers.create') }}" >+ Add
                        New Manager</a>
                </div>
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <div class="col-md-6">
                                <div><h4>List of Managers</h4></div>
                            </div>
                            <div class="col-md-6">
    ...
    <script>
        $(document).on('change', '.toggle-class', function(e) {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '{{ route('managers.change-status') }}',
                data: {
                    'status': status,
                    'user_id': user_id
                },
