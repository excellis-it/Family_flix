            ...
            <div class="d-flex">
                ...
                <div class="">
                    ...
                    <ul class="breadcome-menu mb-0">
                        ...
                        <li><span class="bread-blod"><a href="{{ route('managers.index') }}">
                            Manager</a></span><span class="bread-slash">/</span></li>
                        <li><span class="bread-blod">Update Manager</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <form action="{{ route('managers.update', $manager->id) }}" method="POST" id="project-create-form"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <select name="status" id="" class="form-control">
                                        ...
                                        <option value="1"
                                            @if ($manager['status'] == 1) selected="" @endif>Active
                                        </option>
                                        <option value="0"
                                            @if ($manager['status'] == 0) selected="" @endif>
                                            Inactive</option>
                                    </select>
