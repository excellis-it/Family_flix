        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <form action="{{ route('faq.general.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="add-name">
                                    @foreach ($general_faqs as $key => $vall)
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 pb-3">
                                                <div style="display: flex">
                                                    <textarea name="answer[]" value="{{ $vall->answer }}" class="form-control" id="en-{{ $vall->id }}" rows="5" cols="4">{{ $vall->answer }}</textarea>
                                                </div>
                                            </div>
