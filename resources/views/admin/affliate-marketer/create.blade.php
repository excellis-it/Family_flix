    ...
    <div class="container-fluid">
        <div class="breadcome-list">
            <div class="d-flex">
                ...
                <div class="">
                    <h3>Add New Affiliate Marketer</h3>
                    <ul class="breadcome-menu mb-0">
                        ...
                        <li><span class="bread-blod">Create Affiliate Marketer</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <form action="{{ route('affliate-marketer.store') }}" method="POST" id="project-create-form"
