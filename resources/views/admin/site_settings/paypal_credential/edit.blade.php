                        ...
                        <form action="{{ route('credentials.update', $credential->id) }}" method="POST" id="project-create-form"
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 mb-3">
                                    <label for="inputEnterYourName" class="col-form-label"> Client ID<span
                                            style="color: red;">*</span></label>
                                    <input type="text" name="client_id" id="" class="form-control"
                                        value="{{ $credential['client_id'] }}" placeholder="Enter Client ID">
                                ...
                                <div class="form-group col-md-4 mb-3">
                                    <label for="inputEnterYourName" class="col-form-label">Client Secret <span style="color: red;">*</span></label>
                                    <div class="input-group">
                                        <input type="password" name="client_secret" id="client_secret" class="form-control"
                                               value="{{ $credential['client_secret'] }}" placeholder="Enter Client Secret" autocomplete="off">
