            ...
            <div class="d-flex">
                ...
                <div class="">
                    ...
                    <ul class="breadcome-menu mb-0">
                        ...
                        <li><span class="bread-blod">Edit OTT Icon</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <form action="{{ route('update.ott-service') }}" method="POST" id="project-create-form"
                            enctype="multipart/form-data">
                            @csrf
                            
                            <div class="row">
                                <input type="hidden" name="id" value="{{ $ott_service->id }}">
                                ...
                                @if ($ott_service->icon != '')
                                <img src="{{ Storage::url($ott_service->icon) }}"
                                    alt="preview image" style="height: 150px;width: 200px;background:black;" >
                                @else
