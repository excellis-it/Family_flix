        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <form action="{{ route('show-cms.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <input type="hidden" value="{{ $show_cms->id }}" name="id">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    @if ($show_cms->banner_img != '')
                                        <img src="{{ Storage::url($show_cms->banner_img) }}" alt="preview image"
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" name="heading" value="{{ $show_cms->heading }}"
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <textarea name="small_description" value="{{ $show_cms->small_description }}" class="form-control" rows="6"
                                        cols="8">{{ $show_cms->small_description }}</textarea>
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    @if ($show_cms->top_10_show_background != '')
                                        <img src="{{ Storage::url($show_cms->top_10_show_background) }}"
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    @if ($show_cms->popular_show_background != '')
                                        <img src="{{ Storage::url($show_cms->popular_show_background) }}"
                                            alt="preview image" style="max-height: 180px;">
                                    @else
                                        <img id="preview-back-image"
                                            src="{{ asset('admin_assets/images/NoImageFound.jpg') }}" alt="preview image"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    <input type="text" name="meta_title" class="form-control"
                                        ...
                                        value="{{ old('meta_title', $show_cms->meta_title ?? '') }}">
                                ...
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    <input type="text" name="meta_keyword" class="form-control"
                                        ...
                                        value="{{ old('meta_keyword', $show_cms->meta_keyword ?? '') }}">
                                ...
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    <textarea name="meta_description" class="form-control" rows="3" placeholder="Enter Meta Description">{{ old('meta_description', $show_cms->meta_description ?? '') }}</textarea>
