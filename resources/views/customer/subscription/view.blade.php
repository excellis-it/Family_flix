                            ...
                            <div class="col-lg-8">
                                <div class="subscibtion-list">
                                    <ul>
                                        ...
                                        <li><span class="fw-600">Plan Price:-</span> ${{ $customer_subscription->plan_price ?? 'N/A' }}</li>
                                        <li><span class="fw-600">Coupon Code:-</span> {{ $customer_subscription->coupan_code ?? 'N/A' }}</li>
                                        <li><span class="fw-600">Total Amount:-</span> ${{ $customer_subscription->total ?? 'N/A' }}</li>
