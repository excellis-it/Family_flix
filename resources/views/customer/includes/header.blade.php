                ...
                <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                    ...
                    <div class="profile-dropdown position-relative" data-simplebar="">
                        ...
                        <div class="message-body">
                            <a href="{{route('customer.profile')}}" class="py-8 px-7 mt-8 d-flex align-items-center">
                        ...
                        <div class="message-body">
                            <a href="{{route('customer.password')}}" class="py-8 px-7 mt-8 d-flex align-items-center">
                                <span class="d-flex align-items-center justify-content-center bg-light rounded-1 p-6">
                        ...
                        <div class="d-grid py-4 px-7 pt-8">
                            <a href="{{ route('customer.logout') }}" class="btn btn-outline-primary">Log Out</a>
                        </div>
                    </div>
                </div>
            </li>
