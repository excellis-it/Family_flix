                    ...
                    <div class="login-left">
                        <div class="login-logo logo-fixing">
                            <a href="{{ route('home') }}"> <img
                                    src="{{ Storage::url(General::GeneralCmsContent()->website_logo) }}"
                                    alt=""></a>
                        </div>
                            ...
                            <form action="{{ route('login.check') }}"method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div
                                            class="forgot-ps text-right d-flex justify-content-between align-items-center">
                                            {{-- <div class="remember">
                                                <div class="form-group">
                                    ...
                                    <div class="social_bnr">
                                        <ul>
                                            <li><a class="google_color"
                                                    href="{{ route('social.login', ['provider' => 'google']) }}"><svg
                                            ...
                                            <li><a class="facebook_color"
                                                    href="{{ route('social.login', ['provider' => 'facebook']) }}"><svg
